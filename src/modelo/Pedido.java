...
public class Pedido {
    ...
    // NUEVOS CAMPOS PARA INTEGRACIÓN CON GESTIÓN Y CONTROLADOR
    private int clienteId;
    private int producto1Id;
    private int cantidad1;
    private int producto2Id = -1;
    ...
    // Constructor vacío para integración con gestión y persistencia
    public Pedido() {
	...
	public void setDescripcion(String nextLine) {
		// TODO Auto-generated method stub
		
	}

    // Setters y getters para integración por ID y cantidad
    ...
    public void setProducto1Id(int producto1Id) {
        this.producto1Id = producto1Id;
    }
    public int getProducto1Id() {
        return producto1Id;
    }
    ...
    public void setProducto2Id(int producto2Id) {
        this.producto2Id = producto2Id;
    }
    public int getProducto2Id() {
        return producto2Id;
    }
